//===-- GenMAsmBackend.cpp - GenM Assembler Backend -----------------------===//
//
...
class GenMAsmBackend : public MCAsmBackend {
protected:
  const Target &TheTarget;

public:
  GenMAsmBackend(const Target &T)
  ...
  {
    return createGenMObjectWriter();
  }
};

} // end anonymous namespace

MCAsmBackend *llvm::createGenMAsmBackend(
    const Target &T,
    const MCSubtargetInfo &STI,
    const MCRegisterInfo &MRI,
    const MCTargetOptions &Options)
{
  return new GenMAsmBackend(T);
}
